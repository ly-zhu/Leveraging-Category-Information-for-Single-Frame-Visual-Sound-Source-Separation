...
class MobileNetV2(nn.Module):
    def __init__(self, input_channel0=1, num_classes=1000, output_stride=8, width_mult=1.0, inverted_residual_setting=None, round_nearest=8):
        """
        MobileNet V2 main class
        Args:
            num_channel0 (int): Number of channels of input
        ...
        features = [ConvBNReLU(input_channel0, input_channel, stride=2)]
        current_stride *= 2
        dilation=1
        previous_dilation = 1
...
def mobilenet_v2(input_channel0=3, pretrained=False, progress=True, **kwargs):
    """
    ...
    """
    model = MobileNetV2(input_channel0=input_channel0, **kwargs)
    if pretrained:
